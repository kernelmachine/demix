...
#for tg in "gutenberg","anonymized_realnews" "github_redo","anonymized_openwebtext" "anonymized_tweets_redo","reddit" "cord19-redo","med" "anonymized_latest_news_redo","anonymized_openwebtext" "anonymized_yelp_reviews_redo","anonymized_reviews" "legal_contracts","anonymized_openwebtext" "qasper","cs"; do
for tg in "1b","1b" "cs","cs" "legal","legal" "med","med" "anonymized_openwebtext","anonymized_openwebtext" "anonymized_realnews","anonymized_realnews" "anonymized_reviews","anonymized_reviews" "reddit","reddit"; do
IFS=',' read target_domain force_domain_token <<< "${tg}"
echo $target_domain and $force_domain_token
